...
const title = "Website Accessibility Statement";
const description =
  "Read Amahs Kitchen's accessibility commitment, including keyboard support, image alt text, heading structure, contrast, and issue reporting.";
