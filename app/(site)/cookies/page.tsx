...
const title = "Cookie & Browser Storage Notice";
const description =
  "Learn how Amahs Kitchen uses essential cookies and browser storage for shopping carts, preferences, and secure staff sign-in.";
