...
const title = "Restaurant Ordering Privacy Policy";
const description =
  "Read the Amahs Kitchen privacy policy covering online orders, customer contact details, browser storage, data protection, and your choices.";
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-gutter py-12">
        ...
        <Section title="Cookies">
          <p>
            ...
            <Link href="/cookies" className="font-medium text-secondary hover:underline">Cookie Notice</Link>{" "}
            for details.
          </p>
        </Section>
