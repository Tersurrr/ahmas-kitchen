        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/privacy" className="text-on-surface-variant hover:text-secondary transition-colors">Privacy Policy</Link></li>
              <li><Link href="/cookies" className="text-on-surface-variant hover:text-secondary transition-colors">Cookie Notice</Link></li>
              <li><Link href="/accessibility" className="text-on-surface-variant hover:text-secondary transition-colors">Accessibility</Link></li>
            </ul>
          </div>
