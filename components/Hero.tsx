    ...
    <section id="home" className="relative scroll-mt-16">
      <div className="relative h-[85vh] h-[85dvh] min-h-[560px] w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6 pt-20">
          <div className="absolute inset-x-3 top-16 flex items-center justify-center gap-2 sm:inset-x-auto sm:gap-3 sm:top-16 md:top-20">
            <Image
            ...
            />
            <p className="whitespace-nowrap font-display text-2xl font-bold leading-none tracking-tight text-[#C9A227] sm:text-5xl md:text-6xl">
              Amahs Kitchen
            </p>
          </div>
          <h1
